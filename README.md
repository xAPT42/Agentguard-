...
│ tools.                                                                                               │
│ LLM02  (8 assets)  Sensitive Information Disclosure: this asset can reach secrets, files, or         │
│ databases.                                                                                           │
│ LLM03  (2 assets)  Excessive Agency: the toolset grants more capability than the task requires.      │
│ LLM04  (1 asset)  Supply Chain: the served tool surface no longer matches the approved               │
│ configuration.                                                                                       │
